...
def pred(name , indx):
	"""Function used for prediction of score of a player using SVM's, Random Forests, and ANNs.
	@param name: Name of the player whose score is to be predicted.
	@param indx: Index of the player in a list of all players of the dataset.
	"""
	for i in name:
		print(i)
